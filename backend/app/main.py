...
app.include_router(transporte_regulado.pontos_router, prefix="/api/v2")
app.include_router(transporte_regulado.linhas_router, prefix="/api/v2")
app.include_router(transporte_regulado.ocorrencias_router, prefix="/api/v2")
app.include_router(transporte_regulado.cidadao_denuncias_router, prefix="/api/v2")
app.include_router(transporte_regulado.workflow_router, prefix="/api/v2")
...
app.include_router(pagamentos_lotes.router, prefix="/api/v2")
app.include_router(pagamentos_retencoes.router, prefix="/api/v2")
